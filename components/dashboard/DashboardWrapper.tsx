...
import { LinkIcon, Eye, MousePointerClick, TrendingUp, Plus, ExternalLink, Activity, Sparkles } from "lucide-react"
    ...
    <div className="p-8">
      <div className="mb-8">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-lg">Welcome back! Here's what's happening with your links.</p>
        </motion.div>
      </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Last 3 days performance</p>
                  </div>
              ...
              <CardContent>
                {stats.topLink ? (
                    ...
                    <div className="p-4 rounded-lg bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <p className="font-semibold text-lg mb-1 line-clamp-2">{stats.topLink.title}</p>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-2xl font-bold text-orange-600">{stats.topLink.clicks}</span>
                      </div>
                      <p className="text-xs text-muted-foreground mt-2">Total clicks</p>
                    </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Start sharing your links</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Quick access to your recent links</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Button asChild variant="link" className="h-auto p-0 text-blue-600 font-semibold">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Button asChild variant="link" className="h-auto p-0 text-purple-600 font-semibold">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Button asChild variant="link" className="h-auto p-0 text-green-600 font-semibold">
