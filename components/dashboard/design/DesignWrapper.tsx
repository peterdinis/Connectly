...
import { DesignSettings } from '@/types/ApplicationTypes';
...
const DesignWrapper: FC = () => {
    ...
    const saveDesign = () => {
        toast({
            title: 'Design saved',
            description: 'Your page design has been updated successfully.',
        });
    };
            ...
            <div className="w-full max-w-5xl">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                        Customize every aspect of your public page appearance
                    </p>
                </div>
                ...
                >
                        ...
                        <CardContent>
                            <RadioGroup
                                ...
                                onValueChange={(value) =>
                                    setDesign({
                                        ...design,
                                        layout: value as DesignSettings['layout'],
                                    })
                                }
                            >
                        ...
                        <CardContent>
                            <RadioGroup
                                ...
                                onValueChange={(value) =>
                                    setDesign({
                                        ...design,
                                        theme: value as DesignSettings['theme'],
                                    })
                                }
                            >
                                <div className="grid grid-cols-2 gap-4">
                                    {Object.entries(themes).map(([key, theme]) => (
                                        <div key={key} className="flex items-center space-x-2">
                                            ...
                                            >
                                                <div
                                                    className={`w-6 h-6 rounded-full bg-gradient-to-br ${theme.colors.background}`}
                                                />
                                                {theme.name}
                                            </Label>
                                        </div>
                            ...
                            <CardContent>
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            buttonStyle: value as DesignSettings['buttonStyle'],
                                        })
                                    }
                                >
                            ...
                            <CardContent>
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            cardShadow: value as DesignSettings['cardShadow'],
                                        })
                                    }
                                >
                                    <div className="space-y-3">
                            ...
                            <CardContent>
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            spacing: value as DesignSettings['spacing'],
                                        })
                                    }
                                >
                                    <div className="space-y-3">
                            ...
                            <CardContent>
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            borderStyle: value as DesignSettings['borderStyle'],
                                        })
                                    }
                                >
                                    <div className="space-y-3">
                            ...
                            <CardContent>
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            fontStyle: value as DesignSettings['fontStyle'],
                                        })
                                    }
                                >
                                    <div className="space-y-3">
                                ...
                                <RadioGroup
                                    ...
                                    onValueChange={(value) =>
                                        setDesign({
                                            ...design,
                                            profileImageShape:
                                                value as DesignSettings['profileImageShape'],
                                        })
                                    }
                                >
                                    <div className="space-y-3">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Choose how links animate when appearing
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <RadioGroup
                                ...
                                onValueChange={(value) =>
                                    setDesign({
                                        ...design,
                                        cardAnimation: value as DesignSettings['cardAnimation'],
                                    })
                                }
                            >
                    ...
                    <Button onClick={saveDesign} className="w-full gap-2" size="lg">
